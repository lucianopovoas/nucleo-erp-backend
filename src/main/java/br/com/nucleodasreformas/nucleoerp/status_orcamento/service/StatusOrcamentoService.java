...
public class StatusOrcamentoService {
    ...
    private static final String MENSAGEM_DUPLICIDADE = "Já existe um status de orçamento com esse nome.";
    private static final String INDICE_UNICIDADE = "uk_status_orcamento_nome_normalizado";
    ...
    public StatusOrcamentoResponse atualizar(Long id, StatusOrcamentoRequest request) {
    ...
    private void normalizarNome(StatusOrcamentoRequest request) {
